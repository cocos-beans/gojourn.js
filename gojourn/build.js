...
let cell01 = new objects.Location("cell01", {name: "Prisoner Cell", desc: "This is the cell to which you are bound. It's gross."}, ["cell", "prisonercell"], {north: "hallway01"})

let player = new objects.Actor("player", {name: "player"}, [], "main_menu", [], [], 0, 0, 0, false, 0)
